...
HistoryRestaurant historyRestaurantFromJson(String str) => HistoryRestaurant.fromJson(json.decode(str));

String historyRestaurantToJson(HistoryRestaurant data) => json.encode(data.toJson());
...
class HistoryRestaurant {
  ...
  factory HistoryRestaurant.fromJson(Map<String, dynamic> json) => HistoryRestaurant(
